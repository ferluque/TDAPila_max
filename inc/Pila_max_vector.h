...
#ifndef __Pila_max_vector_H__
#define __Pila_max_vector_H__
 ...
 * un sólo extremo, denominado el @e tope de la pila. Una pila de lungitud @e n la denotamos
 * 
 * - >a1, a2, a3, ..., an>
 * 
